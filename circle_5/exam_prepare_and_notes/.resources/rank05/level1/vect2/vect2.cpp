...
vect2 vect2::operator-() const // temp most with const
{
	vect2 temp = *this;
	temp[0] = -temp[0];
	temp[1] = -temp[1];
...
vect2 vect2::operator*(int num) const // temp most with const
{
	vect2 temp;
...
vect2 vect2::operator+(const vect2& obj) const // temp most with const
{
	vect2 temp = *this;
