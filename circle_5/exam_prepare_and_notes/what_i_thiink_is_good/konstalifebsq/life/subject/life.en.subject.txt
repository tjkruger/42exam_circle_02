...
'x': lift or lower the pen in order to start or stop drawing. Default is: pen not drawing.

Your pen is not moving outside of the board, and will stay still if a command asks for it.
Your pen does nothing in case of invalid command.
